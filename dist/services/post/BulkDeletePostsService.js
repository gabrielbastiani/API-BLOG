...
exports.BulkDeletePostsService = void 0;
...
class BulkDeletePostsService {
    async execute(filePath, user_id) {
        try {
            ...
            const deletePosts = await prisma_1.default.post.deleteMany({
                where: {
                    id: { in: idToDelete },
                },
            });
...
exports.BulkDeletePostsService = BulkDeletePostsService;
//# sourceMappingURL=BulkDeletePostsService.js.map