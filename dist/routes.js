...
const ThemeController_1 = require("./controllers/configuration_blog/theme_setting/ThemeController");
...
const controller = new ThemeController_1.ThemeController();
// -- ROUTES CONFIGURATION BLOG --
...
router.put('/theme', isAuthenticated_1.isAuthenticated, (0, checkRole_1.checkRole)(['SUPER_ADMIN']), [
    (0, validation_chain_builders_1.body)('colors')
        .isObject()
        .custom(value => {
...
// -- ROUTES COMMENT --
router.post('/comment/create_comment', isAuthenticatedBlog_1.isAuthenticatedBlog, new CommentCreateController_1.CommentCreateController().handle);
