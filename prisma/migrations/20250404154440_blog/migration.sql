...
CREATE TABLE "themessettings" (
    ...
    "secondaryColor" TEXT NOT NULL DEFAULT '#1cb929',
    "thirdColor" TEXT NOT NULL DEFAULT '#ef4444',
    "fourthColor" TEXT NOT NULL DEFAULT '#ffffff',
    "fifthColor" TEXT NOT NULL DEFAULT '#f3f4f6',
    "sixthColor" TEXT NOT NULL DEFAULT '#f3f4f6',
    "primarybackgroundColor" TEXT NOT NULL DEFAULT '#f3f4f6',
    "secondarybackgroundColor" TEXT NOT NULL DEFAULT '#000000',
    "thirdbackgroundColor" TEXT NOT NULL DEFAULT '#f9fafb',
    "fourthbackgroundColor" TEXT NOT NULL DEFAULT '#f9fafb',
    "created_at" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
