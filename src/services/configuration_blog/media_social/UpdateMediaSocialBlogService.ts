...
class UpdateMediaSocialBlogService {
    async execute({
        ...
        const mediasSocial = await prismaClient.socialMediasBlog.findUnique({
        ...
        const update_Configs = await prismaClient.socialMediasBlog.update({
            where: {
...
export { UpdateMediaSocialBlogService };